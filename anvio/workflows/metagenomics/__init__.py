...
class MetagenomicsWorkflow(ContigsDBWorkflow, WorkflowSuperClass):
    def __init__(self, args=None, run=terminal.Run(), progress=terminal.Progress()):
        ...
        self.rules.extend(['iu_gen_configs', 'iu_filter_quality_minoche', 'gen_qc_report', 'gzip_fastqs',\
                     ...
                     'krakenuniq', 'krakenuniq_mpa_report', 'import_kraken_hll_taxonomy', 'metaspades',\
        ...
        rule_acceptable_params_dict['krakenuniq_mpa_report'] = ["additional_params"]
        ...
        self.default_config.update({'samples_txt': "samples.txt",
                                    ...
                                    "krakenuniq": {"threads": 3, "--gzip-compressed": True, "additional_params": "--preload"},
