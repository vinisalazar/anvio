...
rule run_mcg_classifier:
    ...
    shell: "anvi-mcg-classifier -p {input.profile} -c {input.contigs} -O {params.output_prefix} --outliers-threshold 2.5 --alpha 0.05 --gen-figures --zeros-are-outliers -C TEST -b Bin_1 -W --debug >> {log} 2>&1"
